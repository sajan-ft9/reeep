    ...
    <div class="mx-2">
      <div class="row">
        <div class="d-flex align-items-center justify-content-lg-between">
          <a href="/" class="logo image-fluid"><img src="{{ asset('assets/img/gov.png') }}" alt=""></a>
          ...
          <a href="/" class="logo"><img class="img-fluid d-none   d-sm-none d-md-block" src="assets/img/nepal-germany.jpg" alt=""  ></a>
          <a href="/" class="logo"><img class="img-fluid d-none   d-sm-none d-md-block" src="assets/img/giz.png" alt="" ></a>
        </div>
      </div>
