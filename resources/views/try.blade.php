    ...
    <header id="header" class="fixed-top ">
        <div class="mx-2">
            <div class="row">
              ...
              <li><a class="nav-link scrollto" href="/#working">Working Areas</a></li>
              ...
              <li><a class="nav-link scrollto" href="/#contact">Contact</a></li> --}}
                ...
                <ul>
                  <li><a href="/knowledge">Knowledge and Resources</a></li>
                  ...
                  <li><a href="/download_links">Downloads and Links</a></li>
                </ul>
              </li> --}}
                            @foreach ($menus as $menu)
                                ...
                                <ul>
                                    @foreach ($submenus as $submenu)
                                        @if ($menu->id == $submenu->parent_id)
                                            <li><a
                                                    href="{{ $menu->slug }}/{{ $submenu->slug }}">{{ $submenu->name }}</a>
                                            </li>
                                        @endif
                                    @endforeach
                                </ul>
...
<div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ asset('assets/img/hero-bg.jpg') }}" class="d-block w-100" style="height: 100vh"
                alt="...">
        ...
        <div class="carousel-item">
            <img src="{{ asset('assets/img/office.JPG') }}" class="d-block w-100" style="height: 100vh"
                alt="...">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
            <img src="{{ asset('assets/img/hero-bg2.jpg') }}" class="d-block w-100" style="height: 100vh"
                alt="...">
            <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="row g-2">
                        <div class="col">
                            <img class="img-fluid w-100" style="height: 100%"
                                src="{{ asset('assets/img/office.JPG') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col wow fadeIn">

                    <h2 class="mb-4">Know About Our Work &amp; History</h2>
                    <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet
                        diam et eos.
                        Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda atque, eos, excepturi
                        praesentium
                        accusantium
                        architecto cum quas delectus debitis hic magnam id, laudantium obcaecati est vitae? Sit
                        iusto sequi quod.
                    </p>
